...
PURGE_CHANNEL_ID = 1545428661304426570
WHITELIST_CHANNEL_ID = 1545429418963636265
LOG_CHANNEL_ID = 1545429204424855602
BOT_LOG_CHANNEL_ID = 1545429204424855602
LOADER_LOG_CHANNEL_ID = 1545429257444925481
USER_CHECK_CHANNEL_ID = 1545429276302639104
KEYS_OVERVIEW_CHANNEL_ID = 1545429363703414824
BOT_STATUS_CHANNEL_ID = 1545429332384813197

BOT_START_TIME = datetime.now()
GUILD_ID = 1545428660679483452
MASTER_ID = "1027571297514967140"

FACE_LOGO_URL = "https://cdn.discordapp.com/attachments/1183028189161869313/1545450752024121374/content.png?ex=6a9c30ac&is=6a9adf2c&hm=b95f96945ad6a26875ad49c554ba8cd8ea9a2ffebd3db9b4d30745a28b4af4cc&"
...
CHECK_CHANNEL_ID = 1545429276302639104
...
async def post_bot_status_start():
    try:
        ...
        if guild:
            ...
            if channel:
                await channel.purge(check=lambda m: m.embeds and m.embeds[0].title and "FACE Status" in m.embeds[0].title)
                embed = build_bot_status_embed()
                await channel.send(embed=embed)
                print("✅ FACE Status Embed gesendet!")
    except Exception as e:
        print(f"FACE Status start error: {e}")
    ...
    while True:
        ...
        try:
            ...
            if guild:
                ...
                if channel:
                    await asyncio.sleep(2)
                    await channel.purge(check=lambda m: m.embeds and m.embeds[0].title and "FACE Status" in m.embeds[0].title, limit=1)
                    embed = build_bot_status_embed()
                    await channel.send(embed=embed)
                    print("✅ FACE Status Embed aktualisiert!")
        except Exception as e:
            print(f"FACE Status loop error: {e}")
            await asyncio.sleep(10)

LOAD_CHANNEL_ID = 1545428661304426570
    ...
    try:
        ...
        if guild:
            ...
            if channel:
                ...
                key_embed.set_thumbnail(url=FACE_LOGO_URL)
                ...
                key_embed.add_field(name="Support", value="> FACE Support", inline=True)
...
DISCORD_TOKEN = "MTM2MTY0NzUxNDY5MTgyOTc4MA.GB5_Cp.eZcLLhPWHpSRATSUIv06L1RioaVkoxHDpOkmmI"
